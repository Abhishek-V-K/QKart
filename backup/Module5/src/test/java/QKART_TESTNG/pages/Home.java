...
public class Home {
    ...
    public Boolean changeProductQuantityinCart(String productName, int quantity) {
        try {
            WebDriverWait wait = new WebDriverWait(driver,10);
            List<WebElement> itemOnCart = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div/div/div/div[1]")));
            List<WebElement> currQuantity = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div/div/div[2]/div[2]/div[1]/div")));
            List<WebElement> minusButton = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div/div/div[2]/div[2]/div[1]/button[1]")));   
            List<WebElement> plusButton = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div/div/div[2]/div[2]/div[1]/button[2]")));  
